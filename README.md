...
# OS.js v3 Wolfenstein 3D Application

The classic Wolf 3D game recreated in HTML5.

![Screenshot](https://raw.githubusercontent.com/os-js/osjs-wolfenstein3d-application/master/screenshot.png)

Uses https://github.com/loadx/html5-wolfenstein3D

## Installation

```bash
npm install --save --production @osjs/wolfenstein3d-application
